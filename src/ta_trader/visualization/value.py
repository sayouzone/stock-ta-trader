...
class ValueChartVisualizer:
    ...
    @staticmethod
    def _plot_price(ax, df: pd.DataFrame, result: ValueAnalysisResult) -> None:
        ...
        if result.take_profit:
            ...
            line = ax.axhline(result.take_profit, color="blue", linewidth=0.8, linestyle="--")
        ...
        if result.stop_loss:
            ...
            line = ax.axhline(result.stop_loss, color="red", linewidth=0.8, linestyle="--")
            line.set_label(label)
            right_handles.append(line)
    ...
    @staticmethod
    def _plot_score(ax, decision: ValueAnalysisResult) -> None:
        ax.axhline(0,    color="black",      linewidth=0.5)
